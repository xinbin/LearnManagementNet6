...
namespace LearnManagement.Web.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Here we are going to add a role after the user has been created.
                    // To start we are going with the very simple, no logic, just asign the default 'user' role:
